...
sing_box_config_shadowsocks() {
    ...
    # РћРїСЂРµРґРµР»СЏРµРј С‚РёРї SS (2022 РёР»Рё old) РїРѕ РЅР°Р»РёС‡РёСЋ : РІ base64 С‡Р°СЃС‚Рё
    if echo "$STRING" | cut -d'/' -f3 | cut -d'@' -f1 | base64 -d 2>/dev/null | grep -q ":"; then
        ...
        # Р•СЃР»Рё method РІ base64, РґРµРєРѕРґРёСЂСѓРµРј
...
check_nft() {
    ...
    # РЎРїРёСЃРѕРє РІСЃРµС… РІРѕР·РјРѕР¶РЅС‹С… СЃРµС‚РѕРІ
    ...
    # РџРѕРєР°Р·С‹РІР°РµРј РїСЂР°РІРёР»Р° СЃ СЃС‡РµС‚С‡РёРєР°РјРё
